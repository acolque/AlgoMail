...
public class AccionBotonEnviados implements EventHandler<ActionEvent> {

	private Stage stage;
	private AlgoMail algoMail;
	private CreadorDeVentanas creador;
	
	public AccionBotonEnviados(Stage stage,AlgoMail algoMail){
    ...
    public void handle(ActionEvent actionEvent) {
		...
		Scene ventana = creador.crearVentanaEnviados(stage,algoMail);
